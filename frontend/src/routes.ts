...
import WrittenExamView from './WrittenExamView.vue';

export const routes = [
    {'path': '/', 'name': 'dashboard', 'component': Dashboard, meta: { requiresAuth: true }},
    {'path': '/login', 'name': 'login', 'component': LoginForm},
    {'path': '/chat/:attemptId', 'name': 'chat', 'component': ChatView, props: true, meta: { requiresAuth: true }},
    {'path': '/written-exam/:attemptId', 'name': 'written-exam', 'component': WrittenExamView, props: true, meta: { requiresAuth: true }},
